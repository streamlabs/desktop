...
export function SpinWheel() {
  ...
  return (
    <WidgetLayout>
      ...
      <Form>
        {w.hasLoadedSettings() && w.selectedTab === 'wheel' && (
          <FormFactory metadata={w.wheelMeta} values={mutableSettings} onChange={w.updateSetting} />
        )}
        {w.hasLoadedSettings() && w.selectedTab === 'categories' && (
          <CategoryEditor
        ...
        {w.hasLoadedSettings() && w.selectedTab === 'sections' && (
          <SectionEditor
        ...
        {w.hasLoadedSettings() && w.selectedTab === 'border' && (
          <FormFactory
        ...
        {w.hasLoadedSettings() && w.selectedTab === 'ticker' && (
          <FormFactory
        ...
        {w.hasLoadedSettings() && w.selectedTab === 'image' && (
