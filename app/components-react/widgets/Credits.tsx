...
interface ICreditsState extends IWidgetCommonState {
  data: {
    ...
    settings: {
      ...
      sponsors_change: string;
      superchats_change: string;
      delay_time: number;
      roll_speed: number;
      roll_time: number;
...
export class CreditsModule extends WidgetModule<ICreditsState> {
  ...
  get includesByPlatform() {
    ...
    const platformEvents: PartialRec<TPlatform, TCreditsMeta> = {
      twitch: {
        ...
        power_ups: metadata.bool({ label: $t('Show Power-Ups') }),
  ...
  get titlesByPlatform() {
    ...
    const platformEvents: PartialRec<TPlatform, TCreditsMeta> = {
      twitch: {
        ...
        power_ups_change: metadata.text({ label: $t('Power-Ups') }),
