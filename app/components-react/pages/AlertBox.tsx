 ...
 */
export default function AlertBox(p: { params?: unknown; className?: string; hidden?: boolean }) {
  return <WidgetEmbed product="alertbox" className={p.className} hidden={p.hidden} />;
}
