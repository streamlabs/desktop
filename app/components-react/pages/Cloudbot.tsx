 ...
 */
export default function Cloudbot(p: { params?: unknown; className?: string; hidden?: boolean }) {
  return <WidgetEmbed product="cloudbot" className={p.className} hidden={p.hidden} />;
}
