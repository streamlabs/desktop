...
export const DestinationSwitchers = memo(() => {
  ...
  const disablePlatformSwitchers = isTwitchDualStreaming && !Utils.isPreview();
...
export type { IDestinationSwitcherHandle };
...
const DestinationSwitcher = memo(
  forwardRef<IDestinationSwitcherHandle, IDestinationSwitcherProps>((p, ref) => {
    ...
    return (
      <SwitcherCard
        ...
        tooltipTitle={
          p.showTwitchTooltip ? $t('Disable Twitch dual stream to add another platform') : undefined
        }
      >
        {/* DISPLAY TOGGLES */}
        <AnimatedWrapper
