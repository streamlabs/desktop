...
export const RESOLUTION_CHANGE_NOTIFICATION_CODE = 'TWITCH_ENHANCED_BROADCASTING_RESOLUTION_CHANGE';
...
function getResolutionChangeNotification(
  ...
  const message =
    resolutionChanges.length === 1
      ? `Your resolution for the ${
          resolutionChanges[0].canvas
        } canvas has been changed to ${formatResolution(
          resolutionChanges[0],
