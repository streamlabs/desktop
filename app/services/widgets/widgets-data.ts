...
export const WidgetDisplayData = (platform?: string): { [x: number]: IWidgetDisplayData } => ({
  [WidgetType.AlertBox]: {
    ...
    supportList: [
      ...
      $t('Follows'),
      $t('Bits'),
      $t('Platforms: Twitch, YouTube, Facebook, X (Twitter) & integrations'),
    ],
    icon: 'icon-alert-box',
  ...
  [WidgetType.ChatBox]: {
    ...
    supportList: [$t('Twitch chat'), $t('YouTube chat'), $t('Facebook chat'), $t('X chat')],
  ...
  [WidgetType.StreamBoss]: {
    ...
    supportList: [$t('Twitch Bits'), $t('Platform support: Twitch, YouTube, Facebook, X')],
    icon: 'fas fa-gavel',
    group: 'interactive',
  },
  [WidgetType.Credits]: {
