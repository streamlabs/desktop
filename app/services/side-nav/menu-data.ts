...
export const compactMenuItemKeys: Set<EMenuItemKey | ESubMenuItemKey> = new Set([
  ...
  EMenuItemKey.AlertBox,
  EMenuItemKey.Cloudbot,
  EMenuItemKey.Widgets,
  EMenuItemKey.AI,
...
export const menuTitles = (item: EMenuItemKey | ESubMenuItemKey | string) => {
  return {
    ...
    [EMenuItemKey.AlertBox]: $t('Alert Box'),
    [EMenuItemKey.Cloudbot]: $t('Cloudbot'),
    [EMenuItemKey.Widgets]: $t('Widgets'),
...
export const SideBarTopNavData = () => {
  ...
  return {
    ...
    menuItems: [
      ...
      menuItems[EMenuItemKey.AlertBox],
      menuItems[EMenuItemKey.Cloudbot],
      menuItems[EMenuItemKey.Widgets],
...
export const SideNavMenuItems = (): TMenuItems => {
  ...
  return {
    ...
    [EMenuItemKey.AlertBox]: {
      key: EMenuItemKey.AlertBox,
      target: 'AlertBox',
      trackingTarget: 'alert-box',
      icon: 'icon-alert-box',
      isActive: true,
      isExpanded: false,
    },
