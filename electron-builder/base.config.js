...
const base = {
  ...
  // Always create resources/overlay/ in the build (empty by default — drop a
  // .overlay file in there to make it the default scene collection at startup).
  extraResources: [{ from: 'overlay-resources', to: 'overlay', filter: ['**/*'] }],
  publish: {
    provider: 'generic',
