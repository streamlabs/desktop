...
// SHA256 fingerprints of the signer certificates used by the binaries shipped with the
// current release of obs-studio-node. Add an entry when the signing certificate changes.
